...
<div id="container" class="clearfix">
	...
	<div id="contents">
		...
		<h2 class="<?php $cat_info = get_category( $cat );{ echo wp_specialchars( $cat_info->slug ); } ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/icon_topics.png" alt="アイコン" width="16" height="20"><?php single_cat_title(); ?>の記事一覧</h2>
		<?php if(have_posts()): ?>
